  ...
  const handleAuth = async (isSignUp: boolean) => {
    ...
    try {
      ...
      if (isSignUp) {
        ...
        setMessage(
          'Login realizado com sucesso! Bem-vindo ao Doce de Leite 🍮'
        )
      }
    } catch (err: any) {
    ...
    <main className="min-h-screen bg-[#FDFBF7] text-[#4A3B32] flex flex-col justify-center items-center p-6">
      <div className="w-full max-w-sm bg-white border border-[#EEDCC5] rounded-3xl p-8 shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black tracking-tight text-[#6D4C41]">
            Doce de Leite
          </h1>

          <p className="text-sm text-[#8D6E63] mt-1">
            Conecte-se com quem você gosta
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-[#795548] mb-1">
              Colocar o seu email
            </label>
          ...
          <div className="flex items-center my-4">
            <div className="flex-grow border-t border-[#EEDCC5]" />

            <span className="px-3 text-xs text-[#A1887F] uppercase">
              ou
            </span>
